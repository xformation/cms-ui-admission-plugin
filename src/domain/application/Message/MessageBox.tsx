...
export class MessageBox extends React.Component<MsgProps, any> {
  ...
  render() {
    ...
    return (
      <main className="m-b-1">
        <div className={`${activeState === -1 ? 'info msgbox-border form-h5' : 'hide'}`}>
          <div>{messageOnClose}</div>
        </div>
        <div
          className={`${
            activeState === 0 ? 'info msgbox-border form-h5 msgbox-width-height' : 'hide'
          }`}
        >
          <div>{message}</div>
        ...
        <div
          className={`${
            activeState === 1
              ? 'success msgbox-border msgbox-padding msgbox-width-height text'
              : 'hide'
          }`}
        >
          {/* <div> */}
        ...
        <div
          className={`${
            activeState === 2
              ? 'error msgbox-border msgbox-padding msgbox-width-height text'
              : 'hide'
          }`}
        >
          {/* <div> */}
