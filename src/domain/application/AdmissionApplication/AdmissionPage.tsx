...
class AdmissionPage extends React.Component<NewAdmissionProps, AdmissionState>{
    ...
    registerSocket() {
        ...
        socket.onmessage = (response: any) => {
            ...
            console.log("AdmissinPage. message received from server ::: ", message);
            this.setState({
    ...
    saveAdmission = (e: any) => {
        const { admissionApplicationData, editAdmissionObject, operationType, academicYearId, branchId } = this.state;
        admissionApplicationData.errorMessage = "";
        this.setState({
