...
import {GET_ADMISSIONAPPLICATION_DATA, SEARCH_ADMISSION_APLICATION,CREATE_ADMISSION_DATA_CACHE} from '../_queries';
...
class AdmissionApplicationPage extends React.Component<any, AdmissionDataState> {
  constructor(props: any) {
    super(props);
