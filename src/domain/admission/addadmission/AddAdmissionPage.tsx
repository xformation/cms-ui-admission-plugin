...
class AddAdmissionPage extends React.Component<any, AddAdmissionPageStates>{
    isActive: any = false;
    totalResult: any;
...
export default graphql(CREATE_ADMISSION_DATA_CACHE, {
    ...
    compose(
      graphql(ADD_ADM_APPLICATION, { name: "addAdmissionApplication" }),
      graphql(ADD_DOCUMENT, { name: "addDocuments" }),
