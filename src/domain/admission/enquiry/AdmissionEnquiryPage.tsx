...
import {GET_ADMISSION_DATA, SEARCH_ADMISSION,CREATE_ADMISSION_DATA_CACHE} from '../_queries';
...
class AdmissionEnquiryPage extends React.Component<any, AdmissionDataState> {
  constructor(props: any) {
    super(props);
