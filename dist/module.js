...
*/
        ...
        /***/ function(module, exports, __webpack_require__) {
          ...
          var AdmissionEnquiryPage = /** @class */ (function(_super) {
              ...
              _this.onClick = function(e) {
                ...
                return mutate({
                  ...
                  .catch(function(error) {
                    btn.removeAttribute('disabled');
                    console.log(
                      'there was an error sending the admission mutation result ',
                      error
                    );
            ...
            AdmissionEnquiryPage.prototype.onClickCheckbox = function(index, e) {
              ...
              var chkBox = document.querySelector('#' + id);
              chkBox.checked = e.nativeEvent.target.checked;
            };
            AdmissionEnquiryPage.prototype.checkAllAdmissions = function(e) {
              var admissionEnquiryData = this.state.admissionEnquiryData;
              var mutateResLength = admissionEnquiryData.mutateResult.length;
              var chkAll = e.nativeEvent.target.checked;
            ...
            AdmissionEnquiryPage.prototype.createNoRecordMessage = function(objAry) {
              var mutateResLength = objAry.length;
              var retVal = [];
              for (var x = 0; x < mutateResLength; x++) {
                ...
                if (length_1 === 0) {
                  retVal.push(
                    React.createElement('h4', {className: 'ptl-06'}, 'No Record Found')
                  );
                }
              }
              return retVal;
            };
            AdmissionEnquiryPage.prototype.createAdmissionRows = function(objAry) {
              var _this = this;
              var mutateResLength = objAry.length;
              var retVal = [];
              for (var x = 0; x < mutateResLength; x++) {
                ...
                var _loop_1 = function _loop_1(i) {
                  ...
                  retVal.push(
                    React.createElement(
                      ...
                      React.createElement(
                        ...
                        React.createElement('input', {
                          onClick: function onClick(e) {
                            return _this.onClickCheckbox(i, e);
                          },
                          checked: admissionEnquiry.isChecked,
                          type: 'checkbox',
                          name: '',
                          id: 'chk' + admissionEnquiry.id,
                        })
                      ),
                      ...
                      React.createElement('td', null, admissionEnquiry.strEnquiryDate),
                      React.createElement(
                        'td',
                        null,
                        React.createElement(
          ...
          exports.default = withAdmissionDataloader_1.default(
            react_apollo_1.compose(
              react_apollo_1.graphql(AdmissionEnquiryListQueryGql, {
                name: 'mutate',
              })
  ...
  \*******************/
        ...
        /***/ function(module, exports, __webpack_require__) {
          ...
          var AdmissionsPage_1 = __webpack_require__(
            /*! ./ui/AdmissionsPage */ './ui/AdmissionsPage.ts'
          );
          exports.AdmissionsPage = AdmissionsPage_1.AdmissionsPage;

          /***/
        },

      /***/ './ui/AdmissionsPage.ts':
        /*!******************************!*\
  !*** ./ui/AdmissionsPage.ts ***!
  \******************************/
        /*! no static exports found */
        /***/ function(module, exports, __webpack_require__) {
          ...
          var AdmissionsPage = /** @class */ (function() {
            function AdmissionsPage() {
              AdmissionsApp_1.default();
            }
            AdmissionsPage.templateUrl = '/partials/admissions.html';
            return AdmissionsPage;
          })();
          exports.AdmissionsPage = AdmissionsPage;
