/*Type definitions for Xformation JavaScript library v1.0.1
Copyright (c) 2006-2019 Synectiks Inc  - http://synectiks.com/
Definitions by: Synectiks Inc 
*/
...
export declare class SurveyCollapseForm extends Survey {
    constructor(props: any);
    toggleForm(): void;
    doRender(): JSX.Element;
